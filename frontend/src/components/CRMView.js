...
export function CRMView() {
    ...
    const lookupConsumerByMsisdn = async (msisdn) => {
        ...
        try {
            ...
            if (existingListExtId)
                setPcConsumerListExtId(existingListExtId);
            else
    ...
    return (_jsxs("div", { children: [_jsx("h2", { children: "\uD83D\uDC64 360\u00B0 Subscriber View" }), _jsxs("div", { style: { display: 'flex', gap: 10, marginBottom: 16, flexWrap: 'wrap' }, children: [_jsxs("select", { value: searchType, onChange: e => setSearchType(e.target.value), children: [_jsx("option", { value: "msisdn", children: "MSISDN" }), _jsx("option", { value: "externalId", children: "External ID" }), _jsx("option", { value: "id", children: "Internal ID" })] }), _jsx("input", { style: { flex: 1, minWidth: 200 }, placeholder: `Enter ${searchType}...`, value: searchValue, onChange: e => setSearchValue(e.target.value), onKeyDown: e => e.key === 'Enter' && search() }), _jsx("button", { onClick: search, disabled: loading || !searchValue, children: loading ? 'Searching...' : 'Search' })] }), error && _jsx("p", { style: { color: 'red' }, children: error }), actionMsg && _jsx("p", { style: { color: 'green', fontSize: 12, background: '#f0fff0', padding: 8, borderRadius: 4 }, children: actionMsg }), actionErr && _jsxs("p", { style: { color: 'red', fontSize: 12, background: '#fff0f0', padding: 8, borderRadius: 4, wordBreak: 'break-all' }, children: ["\u274C ", actionErr] }), (c || cu || p0) && (_jsxs("div", { style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }, children: [_jsxs("div", { children: [p0 && (_jsxs(Card, { title: `Party — ${p0.givenName || ''} ${p0.familyName || ''}`, icon: "\uD83D\uDC64", color: "#f97316", rawData: p0, children: [_jsx(InfoRow, { label: "External ID", value: p0.externalId }), _jsx(InfoRow, { label: "Internal ID", value: p0.id }), _jsx(InfoRow, { label: "Given Name", value: p0.givenName }), _jsx(InfoRow, { label: "Family Name", value: p0.familyName }), _jsx(InfoRow, { label: "Spec", value: p0.individualSpecification?.externalId }), _jsx(InfoRow, { label: "Status", value: p0.status?.slice(-1)[0]?.status }), (p0.contactMedium || []).map((cm, i) => {
                        ...
                        return (_jsxs("div", { style: { border: '1px solid #a7f3d0', borderRadius: 8, padding: 16, background: '#ecfdf5', marginBottom: 16 }, children: [_jsx("h4", { style: { margin: '0 0 12px', color: '#059669' }, children: "\uD83D\uDCB0 Balance Top-Up" }), _jsxs("div", { style: { fontSize: 11, color: '#666', marginBottom: 10, padding: '6px 8px', background: '#fff', borderRadius: 4 }, children: ["Customer: ", _jsx("b", { children: custExtId }), " | Contract: ", _jsx("b", { children: contractExtId }), " | MSISDN: ", _jsx("b", { children: msisdnValue || searchValue })] }), _jsxs("div", { style: { display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 10, marginBottom: 12 }, children: [_jsxs("div", { children: [_jsx("label", { style: { display: 'block', fontSize: 11, fontWeight: 600, marginBottom: 2 }, children: "Amount *" }), _jsx("input", { type: "number", style: { width: '100%', padding: '4px 8px', fontSize: 12 }, value: topUpAmount, onChange: e => setTopUpAmount(e.target.value), placeholder: "e.g. 1000" })] }), _jsxs("div", { children: [_jsx("label", { style: { display: 'block', fontSize: 11, fontWeight: 600, marginBottom: 2 }, children: "Unit of Measure" }), _jsx("select", { style: { width: '100%', padding: '4px 8px', fontSize: 12 }, value: topUpUnit, onChange: e => setTopUpUnit(e.target.value), children: knownUnits.length > 0
                                                    ...
                                                    if (listExtId)
                                                        setPcConsumerListExtId(listExtId);
                                                }, children: [_jsx("option", { value: "", children: "-- Select provider product --" }), products.filter((p) => p.sharingProvider).map((p) => (_jsxs("option", { value: p.externalId, children: [p.name || p.productOfferingExternalId, " (", p.externalId, ")"] }, p.externalId))), _jsx("option", { value: "_custom", children: "Enter manually..." })] }), pcProviderProductExtId === '_custom' && (_jsx("input", { style: { width: '100%', padding: '3px 6px', fontSize: 11, marginTop: 4 }, placeholder: "Provider product external ID", onChange: e => setPcProviderProductExtId(e.target.value) }))] }), pcAction === 'addConsumer' && (_jsxs(_Fragment, { children: [_jsxs("div", { children: [_jsx("label", { style: { display: 'block', fontSize: 11, fontWeight: 600, marginBottom: 2 }, children: "Consumer MSISDN *" }), _jsxs("div", { style: { display: 'flex', gap: 6 }, children: [_jsx("input", { style: { flex: 1, padding: '4px 8px', fontSize: 12 }, value: pcConsumerMsisdn, onChange: e => setPcConsumerMsisdn(e.target.value), placeholder: "Enter consumer MSISDN to lookup" }), _jsx("button", { onClick: () => lookupConsumerByMsisdn(pcConsumerMsisdn), disabled: pcLookupLoading || !pcConsumerMsisdn, style: { fontSize: 11, padding: '4px 10px', background: '#dbeafe', border: '1px solid #93c5fd', borderRadius: 4, cursor: 'pointer' }, children: pcLookupLoading ? '...' : '🔍 Lookup' })] })] }), _jsxs("div", { children: [_jsxs("label", { style: { display: 'block', fontSize: 11, fontWeight: 600, marginBottom: 2 }, children: ["Consumer Customer External ID ", pcConsumerCustExtId ? '✓' : '*'] }), _jsx("input", { style: { width: '100%', padding: '4px 8px', fontSize: 12, background: pcConsumerCustExtId ? '#f0fff4' : '#fff' }, value: pcConsumerCustExtId, onChange: e => setPcConsumerCustExtId(e.target.value), placeholder: "Auto-filled from lookup" })] }), _jsxs("div", { children: [_jsxs("label", { style: { display: 'block', fontSize: 11, fontWeight: 600, marginBottom: 2 }, children: ["Consumer Contract External ID ", pcConsumerContractExtId ? '✓' : '*'] }), _jsx("input", { style: { width: '100%', padding: '4px 8px', fontSize: 12, background: pcConsumerContractExtId ? '#f0fff4' : '#fff' }, value: pcConsumerContractExtId, onChange: e => setPcConsumerContractExtId(e.target.value), placeholder: "Auto-filled from lookup" })] })] })), _jsxs("div", { children: [_jsxs("label", { style: { display: 'block', fontSize: 11, fontWeight: 600, marginBottom: 2 }, children: ["Provider's Consumer List External ID ", pcAction === 'removeConsumer' ? '*' : `${pcConsumerListExtId ? '✓' : '(from provider)'}`] }), _jsx("input", { style: { width: '100%', padding: '4px 8px', fontSize: 12, background: pcConsumerListExtId ? '#f0fff4' : '#fff' }, value: pcConsumerListExtId, onChange: e => setPcConsumerListExtId(e.target.value), placeholder: "Auto-filled from provider's sharingProvider.consumerList" })] })] })), pcAction === 'addConsumer' && pcConsumerCustExtId && (_jsxs("div", { style: { padding: '8px 10px', background: '#f0fdf4', borderRadius: 6, border: '1px solid #bbf7d0', marginBottom: 12 }, children: [_jsx("div", { style: { fontSize: 11, fontWeight: 600, marginBottom: 6 }, children: "\uD83D\uDCE6 Consumer Product Offering" }), _jsxs("div", { style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 8 }, children: [_jsxs("div", { children: [_jsx("label", { style: { display: 'block', fontSize: 10, marginBottom: 2 }, children: "Consumer PO *" }), _jsxs("select", { style: { width: '100%', padding: '4px 8px', fontSize: 11 }, value: pcConsumerPO, onChange: e => {
