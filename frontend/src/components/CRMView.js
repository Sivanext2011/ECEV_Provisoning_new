...
export function CRMView() {
    ...
    const BucketCard = ({ bucket, productExtId }) => {
        ...
        const [adjAction, setAdjAction] = React.useState('Relative');
