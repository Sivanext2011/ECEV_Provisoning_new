...
export function ProvisionWizard() {
    ...
    const [additionalPOs, setAdditionalPOs] = useState([{ poExtId: '', formVals: {}, baRef: true, baRefRecurrence: true, popData: [], popVals: {}, popEnabled: false, popSelected: {}, popLoading: false }]);
